...
func (m *MockStore) TransferTX(ctx context.Context, req db.TransferTXParams) (db.TransferTXResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTX", ctx, req)
...
func (mr *MockStoreMockRecorder) TransferTX(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransferTX", reflect.TypeOf((*MockStore)(nil).TransferTX), ctx, req)
}
