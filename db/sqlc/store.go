...
func (store *Store) executeTx(ctx context.Context, fn func(db *Queries) error) error {
...
func (store *Store) TransferTX(ctx context.Context, req TransferTXParams) (TransferTXResponse, error) {
